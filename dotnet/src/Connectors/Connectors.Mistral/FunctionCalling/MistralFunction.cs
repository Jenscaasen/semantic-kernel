...
// changes as Mistral's APIs evolve, these types are not externally constructible. In the future, once
// things stabilize, and if need demonstrates, we could choose to expose those constructors.

/// <summary>
/// Represents a function parameter that can be passed to an Mistral function tool call.
/// </summary>
public sealed class MistralFunctionParameter
{
    internal MistralFunctionParameter(string? name, string? description, bool isRequired, Type? parameterType, KernelJsonSchema? schema)
    {
...
/// <summary>
/// Represents a function return parameter that can be returned by a tool call to Mistral.
/// </summary>
public sealed class MistralFunctionReturnParameter
{
    internal MistralFunctionReturnParameter(string? description, Type? parameterType, KernelJsonSchema? schema)
    {
        this.Description = description ?? string.Empty;
        this.Schema = schema;
        this.ParameterType = parameterType;
...
/// <summary>
/// Represents a function that can be passed to the Mistral API
/// </summary>
public sealed class MistralFunction
{
    /// <summary>
    ...
    /// <summary>Initializes the MistralFunction.</summary>
    internal MistralFunction(
        string? pluginName,
        string functionName,
        string? description,
        IReadOnlyList<MistralFunctionParameter>? parameters,
        MistralFunctionReturnParameter? returnParameter)
    {
    ...
    public IReadOnlyList<MistralFunctionParameter>? Parameters { get; }

    /// <summary>Gets the return parameter of the function, if any.</summary>
    public MistralFunctionReturnParameter? ReturnParameter { get; }

    /// <summary>
    /// Converts the <see cref="MistralFunction"/> representation
